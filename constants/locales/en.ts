...
const en: LocaleData = {
  ...
  drafts: {
    ...
    // Server-side filters + draft origin (Aug 2026)
    searchPlaceholder: 'Search {{count}} drafts',
    sourceManual: 'Manual',
    sourceAutomation: 'Automation',
    badgeNew: 'New',
    filteredCount: {
      one: '{{count}} matching draft',
      other: '{{count}} matching drafts',
    },
    noResultsTitle: 'No matching drafts',
    noResultsHelp: 'Try a different search, or clear the filters to see every draft.',
    clearFilters: 'Clear filters',
    alreadyPublished: 'Already published somewhere else',

    // Drafts list redesign (Aug 2026)
    filterAll: 'All {{count}}',
    filterReady: 'Ready {{count}}',
    filterPastDate: 'Past date {{count}}',
    filterNeedsWork: 'Needs work {{count}}',
    sortLabel: 'Sort',
    sortLastEdited: 'Last edited',
    sortDate: 'Date',
    sortConfidence: 'Confidence',
    sourceLabel: 'Source',
    pastDateShort: 'Date has passed — needs a new date',
    confidenceLabel: '{{score}}% confidence',
    batchReady: '{{count}} ready to publish',
    batchSubtitle: 'Reviewed and complete',
    batchPublishAll: 'Publish all',
    batchPastDated: '{{count}} with a past date',
    batchPastSubtitle: 'Cannot be published as they are',
    batchRemovePast: 'Remove',
    batchDeleteConfirmTitle: 'Delete {{count}} past-dated drafts?',
    batchDeleteConfirmMessage:
      'This permanently deletes every draft dated in the past, across your whole list — not just the ones on screen. It cannot be undone.',
    batchDeleteConfirmCta: 'Delete permanently',
    batchDeleteResult: 'Deleted {{deleted}} of {{total}}.',
    batchDeleteNone: 'No past-dated drafts left to delete.',
    batchCappedNotice: 'Deleting the first {{count}} — run it again for the rest.',
    batchConfirmTitle: 'Publish {{count}} drafts?',
    batchConfirmMessage: 'These drafts are complete and dated in the future. They go public now.',
    batchResult: 'Published {{published}} of {{total}}.',
    batchStoppedRateLimit: 'Stopped early — too many requests. The rest are unchanged.',
    batchStoppedBackground: 'Stopped when the app went to the background. The rest are unchanged.',
    swipeHint: 'Swipe a row for publish and delete',
    accessibilityPublish: 'Publish draft',
    accessibilityRowHint: 'Opens the editor. Actions: publish, delete.',
    accessibilityRowHintNotReady: 'Opens the editor. Action: delete.',

    // Triage mode
    triageTitle: 'TRIAGE QUEUE',
    triageHeadline: '{{count}} drafts need a decision',
    triageHelper: '{{past}} have a date in the past. {{ready}} are ready to go out.',
    triageStart: 'Start triage',
    triagePublishReady: 'Publish {{count}}',
    triageSkipHint: 'swipe up to skip',
    triageOpenEditor: 'Open full editor',
    triageCorroborated: 'What the crawler corroborated',
    triageChecksRan: '{{ran}} of {{total}} ran',
    triageNotScored: 'You created this draft — no confidence score',
    triageDatePassed: '{{date}} has passed',
    triagePickDate: 'Pick…',
    triageCappedByDate: 'The date could not be found on the source page.',
    triageReadFullDescription: 'Read full description',
    triageRelativeHint: 'in {{count}} days',
    checkFound: 'found',
    checkPartly: 'partly',
    ...
    deletedToastHelper: 'Removed from your drafts',
    undo: 'Undo',
    queueClearedTitle: 'Queue cleared',
    queueClearedHelper: 'Every draft in the queue has a decision.',
    summaryPublished: 'Published',
    summaryRescheduled: 'Rescheduled, then published',
    summaryDeleted: 'Deleted',
    summarySkipped: 'Skipped for later',
    backToDrafts: 'Back to drafts',
    reviewSkipped: 'Review the {{count}} I skipped',
    queueRemaining: '{{count}} drafts left in your list.',
  },
  ...
  privacyCenter: {
    ...
    notificationsDescription: "To remind you on the day of events you've saved",
  ...
  weather: {
    ...
    mayChange: 'May still change',
    updatedHoursAgo: 'Updated {{count}} h ago',
    // Open-Meteo's CC BY 4.0 terms require a link wherever their data is shown.
    attribution: 'Based on Open-Meteo data',
    attributionLinkA11y: 'Open the Open-Meteo website',
    // Shown only when the forecast does not cover the whole event.
    windowFromNow: 'From now until {{time}}',
    windowForDay: 'Forecast for {{day}}',
    metrics: {
      temp: '{{min}}–{{max}} °C',
      tempSingle: '{{value}} °C',
      tempBelowZero: '{{min}} to {{max}} °C',
      feels: 'feels {{min}}–{{max}}°',
      feelsSingle: 'feels {{value}}°',
      feelsBelowZero: 'feels {{min}} to {{max}}°',
      rain: 'rain {{value}}%',
    ...
    // Never discourage attending or imply safety. Keys ending in _N are
    // alternative wordings of one situation; the card shows one per event.
    tips: {
      thunder: "Thunderstorms possible — keep an eye on the organizers' updates.",
      thunder_rain_1: 'Thunder and rain: bring a rain jacket or poncho.',
      thunder_rain_2: 'Thunder and rain: take shelter in time if needed.',
      heat_1: 'Hot: bring at least one water bottle.',
      heat_2: 'Hot: keep your head covered.',
      heat_3: 'Hot: wear light linen or cotton clothes.',
      freezing_1: 'Very cold: wear thermal underwear.',
      freezing_2: 'Very cold: bring a scarf and gloves.',
      freezing_3: 'Very cold: nothing can stop you!',
      freezing_4: 'Very cold: bring a thermos!',
      wind_strong: 'Strong gusts: big banners turn into sails — secure them or go small.',
      cold_rain_1: "Cold and rainy: don't let it get you down — marching warms you up.",
      cold_rain_2: 'Cold and rainy: nothing stops you! Take to the streets!',
      cold_rain_3: 'Cold and rainy: wear thick socks and waterproof shoes.',
      cold_rain_4: "Cold and rainy: don't forget your thermos.",
      cold_rain_5: 'Cold and rainy: wear a thick rain jacket.',
      cold_rain_6: 'Cold and rainy: put on rain trousers!',
      cold_rain_7: 'Cold and rainy: a keffiyeh can protect you from light rain.',
      cold_rain_8: 'Cold and rainy: an umbrella makes you friends fast.',
      wind_rain: 'Windy and rainy: bring a rain jacket or poncho.',
      sun_rain_1: 'Sun and rain: come ready for anything!',
      sun_rain_2: 'Sun and rain: water bottle + rain jacket + sunglasses.',
      rain_1: "Rain: at least it's good for the plants.",
      rain_2: 'Rain: bring a rain jacket or poncho.',
      rain_3: 'Rain: wear waterproof shoes.',
      showers: 'Might drizzle: pack a light rain jacket, just in case.',
      uv_high: 'Strong sun: suncream on — the only thing that should burn is your passion.',
      sunny_warm_1: "Sunny and warm: don't forget your water bottle — chanting is thirsty work.",
      sunny_warm_2: 'Sunny and warm: a keffiyeh can shield you from the sun.',
      sunny_warm_3: 'Sunny and warm: bring your sunglasses.',
      sunny_warm_4: "Sunny and warm: don't get sunburnt!",
      warm: 'Warm: bring a water bottle — chanting is thirsty work.',
      wind_1: "Windy: don't get blown away!",
      wind_2: 'Windy: hold on tight to your banner.',
      wind_3: 'Windy: nothing can knock you off your feet.',
      cold_1: "Cold: don't let it get you down — marching warms you up.",
      cold_2: 'Cold: wear a thick coat.',
      cold_3: 'Cold: a thermos can come in handy.',
      dark: 'It gets dark at {{time}} — something reflective or a small light helps.',
      sunny_1: 'Perfect protest weather: no excuses not to come!',
      sunny_2: 'Perfect protest weather: bring your sunglasses.',
      sunny_3: "Perfect protest weather: don't get sunburnt!",
      perfect: 'Perfect protest weather: no excuses not to come!',
    },
  },
};
